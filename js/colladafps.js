...
//ray cast for gravity 
var raycaster;

//an array list of virtual world objects
...
//rester
	...
	"<br> camera.position.y = " + camera.position.y + ".<br>" +
	"<br> intersections.length = "	+ intersections.length + ".<br>"+
	"<br>yVelocity = "  + yVelocity + ".<br>";
